...
public class WheelMain {
	...
	public void initDateTimePicker(int year, int month) {
		this.initDateTimePicker(year, month, 0, 0, 0, 0);
	}
...
//		}
		...
		wv_second.setAdapter(new NumericWheelAdapter(
				0, 59));
...
//	}
	public String getTime() {
		...
		int second = wv_second.getCurrentItem();
		if (month < 9) {
			strMon = "0" + month;
		} else {
		...
		if (!hasSelectTime) {
			sb.append((wv_year.getCurrentItem() + START_YEAR)).append("-")
					...
					.append(strDay).append(" ").append(strHour).append(":").append(strMin).append(":").append(strSecond);
		}else{
			sb.append((wv_year.getCurrentItem() + START_YEAR)).append("-")
					.append(strMon).append("-")
					.append(strDay).append(" ").append(strHour).append(":").append(strMin).append(":").append(strSecond);
...
//		}
	...
	public String getHours() {
		...
		append(wv_mins.getCurrentItem()).append(":").append(wv_second.getCurrentItem());
